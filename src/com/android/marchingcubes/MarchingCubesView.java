...
public class MarchingCubesView extends GLSurfaceView {
    ...
    public MarchingCubesView(Context context) {
        super(context);
        init(false, 0, 0);
    }

    public MarchingCubesView(Context context, boolean translucent, int depth, int stencil) {
        super(context);
    ...
    private static class Renderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceChanged(GL10 gl, int width, int height) {
        	MarchingCubesLib.init(width, height);
        }
